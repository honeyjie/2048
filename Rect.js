...
window.onload = function(){
	...
	if (width > 800) {
		...
		console.log(W/ratio)
		scoretext.style.marginLeft = (width - W/ratio)/2 + "px";
		newgame.style.marginRight =  (width - W/ratio)/2 + "px";
		h1.style.margin = "1%";
		canvas.style.left = (width - W/ratio)/2 + "px";
		W = W /0.8;

	} else{
		W = width;
		canvas.style.left = (width - 0.8*W)/2 + "px";
		canvas.style.width = 0.8*W + "px";
		canvas.style.height = 0.8*W + "px";
	}
